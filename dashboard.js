...
document.addEventListener('DOMContentLoaded', async () => {
        ...
        for (let i = 0; i < maxSlots; i++) {
            ...
            if (userCharacters[i]) {
                ...
                slotDiv.innerHTML = `
                    ...
                    <a href="${window.getUrl('create-character')}" class="create-char-btn mt-4 action-btn btn-green">Create Character</a>
                `;
            }
    ...
    document.getElementById('go-to-market-btn').addEventListener('click', () => {
        ...
        window.location.href = window.getUrl('marketplace');
    });
        ...
        dashboardContent.addEventListener('click', async (event) => {
            ...
            if (target.matches('#logout-btn')) {
                ...
                showConfirmModal({ title: 'Confirm Logout', message: 'Are you sure you want to end your session?', onConfirm: () => {
                    ...
                    window.location.href = window.getUrl('index');
                }});
                return;
            }
    ...
    if (user) {
        ...
        window.location.href = window.getUrl('login');
    }
});